...
const Thesis:React.FC<any>=(p)=><BrutalistHesitantWriter {...p} contextTitle="Assignment 1 · two changes you can explain" contextItems={[{label:'Starter evidence',detail:'A playable baseline; not your finished assignment.'},{label:'Your contribution',detail:'New character, new landings, verified behavior.'}]} yOffset={-80} brandLabel="@NikBearBrown"/>;
